  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <span className="inline-flex items-center rounded-full bg-gray-100 px-3 py-1 text-sm font-medium text-gray-800">
          <User className="-ml-0.5 mr-1.5 h-4 w-4" aria-hidden="true" />
          {project.client}
        </span>
      </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4 w-0 flex-1">
                <dl>
                  ...
                  <dd className="flex items-baseline">
                    <div className="text-lg font-semibold text-gray-900">
                      ${project.billing.outstanding.toLocaleString()} outstanding
                    </div>
                  </dd>
                </dl>
              </div>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-3 w-0 flex-1">
                            <dl>
                              ...
                              <dd className="flex items-baseline">
                                <div className="text-lg font-semibold text-gray-900">
                                  ${project.billing.totalInvoiced.toLocaleString()}
                                </div>
                              </dd>
                            </dl>
                          </div>
                    ...
                    <div className="overflow-hidden rounded-lg bg-white shadow">
                      <div className="p-4">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3 w-0 flex-1">
                            <dl>
                              <dt className="truncate text-sm font-medium text-gray-500">Total Paid</dt>
                              <dd className="flex items-baseline">
                                <div className="text-lg font-semibold text-gray-900">
                                  ${project.billing.totalPaid.toLocaleString()}
                                </div>
                              </dd>
                            </dl>
                          </div>
                    ...
                    <div className="overflow-hidden rounded-lg bg-white shadow">
                      <div className="p-4">
                        <div className="flex items-center">
                          <div className="flex-shrink-0 rounded-md bg-orange-500 p-2">
                          ...
                          <div className="ml-3 w-0 flex-1">
                            <dl>
                              ...
                              <dd className="flex items-baseline">
                                <div className="text-lg font-semibold text-gray-900">
                                  ${project.billing.outstanding.toLocaleString()}
                                </div>
                              </dd>
                            </dl>
                          </div>
                    ...
                    <div className="overflow-hidden rounded-lg border border-gray-200">
                      <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="divide-y divide-gray-200 bg-white">
                          <tr>
                            <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">INV-001</td>
                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">2023-04-01</td>
                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">$5,000</td>
                          ...
                          <tr>
                            <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">INV-002</td>
                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">2023-05-01</td>
                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">$5,000</td>
                            <td className="whitespace-nowrap px-6 py-4">
                              <span className="inline-flex rounded-full bg-green-100 px-2 text-xs font-semibold leading-5 text-green-800">
                                Paid
                          ...
                          <tr>
                            <td className="whitespace-nowrap px-6 py-4 text-sm font-medium text-gray-900">INV-003</td>
                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">2023-06-01</td>
                            <td className="whitespace-nowrap px-6 py-4 text-sm text-gray-500">$2,450</td>
                            <td className="whitespace-nowrap px-6 py-4">
            ...
            <div>
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div>
                      <h4 className="text-sm font-medium text-gray-500">Next Invoice Date</h4>
                      <p className="mt-1 text-sm text-gray-900">{project.billing.nextInvoiceDate}</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-medium text-gray-500">Payment Method</h4>
                      <p className="mt-1 text-sm text-gray-900">Credit Card (**** **** **** 1234)</p>
                    </div>
                    <div>
                      <h4 className="text-sm font-medium text-gray-500">Billing Contact</h4>
                      <p className="mt-1 text-sm text-gray-900">billing@acmecorp.com</p>
                    </div>
                    <div>
                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <button className="w-full inline-flex justify-center rounded-md bg-primary-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600">
                        Generate Invoice
                      </button>
                    </div>
                  </div>
