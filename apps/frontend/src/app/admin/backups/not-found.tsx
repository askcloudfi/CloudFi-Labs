...
export default function BackupsNotFound() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-8">
      <div className="flex min-h-[400px] flex-col items-center justify-center gap-6 py-12">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Backup Management Not Found</h1>
          <p className="mt-2 text-gray-500">
            The backup management section you're looking for doesn't exist or has been removed.
          </p>
        </div>
